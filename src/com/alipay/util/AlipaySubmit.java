...
public class AlipaySubmit {
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        System.out.println("AlipaySubmit.buildRequestPara()"+", sParaTemp.size()="+sParaTemp.size());
        //除去数组中的空值和签名参数
        ...
        System.out.println("AlipaySubmit.buildRequestPara()"+", mysign="+mysign);
        System.out.println("AlipaySubmit.buildRequestPara()"+", sign_type="+AlipayConfig.sign_type);
        return sPara;
    }
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        System.out.println("AlipaySubmit.buildRequest()"+", sParaTemp.size()"+sParaTemp.size()+", strMethod="+strMethod+", strButtonName="+strButtonName);
        //待请求参数数组
        ...
        System.out.println("AlipaySubmit.buildRequest()"+", sParaTemp.size()"+sParaTemp.size()+", strMethod="+strMethod+", strButtonName="+strButtonName+", sbHtml="+sbHtml);
